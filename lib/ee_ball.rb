class EeBall
  ...
  def quotes
    if @ee_image == "eric"
      ...
      @quote = ["OH!", "Neat!", "Great!", "Have a fortune cookie!", "oh wow", "Do you want a clinic on that?"].sample
    elsif @ee_image == "richard"
      @quote = ["It's about time I fixed that.", "Uhh...", "Yeah.","Let's put a binding.pry in there."].sample
